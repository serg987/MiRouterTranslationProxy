translation = {
    '欢迎使用Redmi路由器': {'en': 'Welcome to Redmi router', 'ru': 'Добро пожаловать в роутер Redmi'},
    '下载小米WiFi APP管理路由器': {
        'en': 'Download Xiaomi Wi-Fi APP to manage the router',
        'ru': 'Скачайте приложение Xiaomi Wi-Fi для управления роутером'
    },
    '使用小米WiFi APP免除记密码烦恼': {
        'en': 'Use Xiaomi Wi-Fi APP to avoid the trouble of remembering passwords',
        'ru': 'Используйте приложение Xiaomi Wi-Fi, чтобы избежать трудностей с запоминанием паролей'
    },
    'Redmi路由器': {'en': 'Redmi router', 'ru': 'Роутер Redmi'},
    '请输入路由器管理密码': {'en': 'Please enter the router password', 'ru': 'Введите пароль роутера'},
    '官方网站': {'en': 'Official website', 'ru': 'Официальный сайт'},
    '官方微博': {'en': 'Official Weibo', 'ru': 'Официальный Weibo'},
    '官方微信': {'en': 'Official WeChat', 'ru': 'Официальный WeChat'},
    '用户社区': {'en': 'Community', 'ru': 'Сообщество'},
    '常见问题': {'en': 'FAQ'},
    '服务热线': {'en': 'Service Hotline', 'ru': 'Горячая линия'},
    '家': {'en': 'Home', 'ru': 'Дом'},
    '修改路由器名称': {'en': 'Change router name', 'ru': 'Изменить имя роутера'},
    '系统升级': {'en': 'Software update', 'ru': 'Обновление ПО'},
    '下载客户端': {'en': 'Download App', 'ru': 'Скачать приложение'},
    '重启': {'en': 'Reboot', 'ru': 'Перезагрузить'},
    '注销': {'en': 'Logout', 'ru': 'Выход'},
    '路由状态': {'en': 'Status', 'ru': 'Состояние'},
    '常用设置': {'en': 'Common Settings', 'ru': 'Общие настройки'},
    '高级设置': {'en': 'Advanced settings', 'ru': 'Расширенные настройки'},
    '终端设备': {'en': 'Clients', 'ru': 'Клиенты'},
    '互联网': {'en': 'Internet ', 'ru': 'Интернет '},
    '台': {'en': 'pcs.', 'ru': 'шт.'},
    ...
    '连接设备数量': {'en': 'Number of connected devices', 'ru': 'Подключенных устройств'},
    ...
    '开启': {'en': 'On', 'ru': 'Вкл'},
    '关闭': {'en': 'Off', 'ru': 'Выкл'},
    '隐藏网络不被发现': {'en': 'Hidden network', 'ru': 'Скрытая сеть'},
    '加密方式': {'en': 'Encryption', 'ru': 'Шифрование'},
    '无加密(允许所有人连接)': {'en': 'No encryption (everyone can connect)', 'ru': 'Без шифрования (все могут подключаться)'},
    '强加密(WPA2个人版)': {'en': 'Strong (WPA2 Personal)', 'ru': 'Сильное (WPA2 персональное)'},
    '混合加密(WPA/WPA2个人版)': {'en': 'Hybrid (WPA/WPA2 Personal)', 'ru': 'Гибрид (WPA/WPA2 персональное)'},
    '无线信道': {'en': 'Channel', 'ru': 'Канал'},
    '自动': {'en': 'Auto', 'ru': 'Авто'},
    '频段': {'en': 'Frequency', 'ru': 'Частота'},
    '信号强度': {'en': 'Signal Strength', 'ru': 'Мощность сигнала'},
    '穿墙': {'en': 'Max', 'ru': 'Максимум'},
    ...
    '使用小米WiFi APP管理您的路由器': {
        ...
        'ru': 'Управляйте своим роутером с помощью приложения Xiaomi Wi-Fi '
    },
    '易用': {'en': 'Easy to use ', 'ru': 'Легкое в использовании'},
    '全新小米WiFi APP 极简操作，享受生活': {
        'en': 'The new Xiaomi Wi-Fi APP is extremely simple to operate and makes life easier',
        'ru': 'Новое приложение Xiaomi Wi-Fi чрезвычайно простое в использовании и делает жизнь проще'
    },
    '安全': {'en': 'Safe', 'ru': 'Безопасно'},
    '7x24小时安全防护 一键拉黑蹭网老王': {'en': '7x24 security protection', 'ru': 'Защита 24/7'},
    '加速': {'en': 'Speed', 'ru': 'Скорость'},
    '提高带宽，游戏加速 团战胜人一筹': {'en': 'Improve bandwidth, speed up games, team up to beat others '},
    '分享WiFi赚点钱 欢迎老王来蹭网': {'en': 'Share Wi-Fi to make money'},
    '赚钱': {'en': 'Earn money'},
    '处理中': {'en': 'Processing', 'ru': 'Обработка'},
    '提示信息': {'en': 'Prompt information', 'ru': 'Информация'},
    '确认信息': {'en': 'Confirm information', 'ru': 'Подтверждение'},
    '检测到最新版本为': {'en': 'The latest version is', 'ru': 'Последняя версия - '},
    '5G WiFi启动失败': {'en': '5G Wi-Fi failed to start', 'ru': '5G Wi-Fi не смогла запуститься'},
    '检测到与上级路由器存在IP冲突': {
        'en': 'Detected IP conflict with WAN device',
        'ru': 'Обнаружен конфликт с устройством WAN'
    },
    '路由器关机': {'en': 'Shutdown router', 'ru': 'Выключить устройство'},
    '密码错误': {
        'en': 'Wrong password. If you enter the wrong password more than 3 times, you will be blocked from trying',
        'ru': 'Неправильный пароль. Если Вы введете неправильный пароль более 3 раз, Вы не сможете его больше ввести'
             },
    '多次密码错误，将禁止继续尝试': {
        'en': 'Wrong password entered more than 3 times, you are blocked from trying',
        'ru': 'Неверный пароль введен более 3 раз, ввод заблокирован'
    },
    '现在安装': {'en': 'Install now', 'ru': 'Установить сейчас'},
    '不支持手机端网页管理路由器4': {'en': 'Does not support mobile phone web management router 4'},
    '确认': {'en': 'Confirm', 'ru': 'Подтвердить'},
    ...
    '输入格式不正确': {'en': 'Incorrect input format', 'ru': 'Неверный формат ввода'},
    'IP地址由4个 0~255 之间的数字组成，数字之间用点区隔': {'en': 'An IP address consists of 4 numbers between 0 and 255, separated by dots '},
    'IPv6地址由8组四个十六进制数组成，每组之间用:区隔': {'en': 'An IPv6 address consists of 8 groups of four hexadecimal numbers, and each group is separated by:'},
    'LAN IPv6前缀需要以::结尾': {'en': 'LAN IPv6 prefix must end with ::'},
    '必须是完整的URL,如': {'en': 'Must be a full URL, like as'},
    'Wi-Fi双频合一': {'en': 'Wi-Fi dual-band in one', 'ru': 'Два диапазона Wi-Fi в одной сети'},
    '上网信息': {'en': 'Internet information', 'ru': 'Информация Интернет'},
    '连接类型': {'en': 'Connection Type', 'ru': 'Тип подключения'},
    'IP地址': {'en': 'IP address', 'ru': 'IP адрес'},
    '子网掩码': {'en': 'Subnet mask', 'ru': 'Маска подсети'},
    '默认网关': {'en': 'Default gateway', 'ru': 'Шлюз по умолчанию'},
    'IPv6连接类型': {'en': 'IPv6 connection type', 'ru': 'Тип подключения IPv6'},
    '必填': {'en': 'Required ', 'ru': 'Требуется'},
    '自动配置DNS': {'en': 'Automatic DNS configuration ', 'ru': 'Автоматическая настройка DNS'},
    '手动配置DNS': {'en': 'Manually configured DNS ', 'ru': 'Ручная настройка DNS'},
    '静态IP': {'en': 'Static IP', 'ru': 'Статический IP'},
    '上网方式': {'en': 'Internet access ', 'ru': 'Доступ в Интернет'},
    'WAN口速率': {'en': 'WAN port speed', 'ru': 'Скорость порта WAN'},
    '自动（推荐）': {'en': 'Auto (recommended)', 'ru': 'Авто (рекомендуется)'},
    '速率': {'en': 'Speed', 'ru': 'Скорость'},
    'MAC地址克隆': {'en': 'MAC address cloning', 'ru': 'Клонирование MAC адреса'},
    '当前使用的MAC地址是': {'en': 'The currently used MAC address is ', 'ru': 'Текущий используемый MAC-адрес '},
    '克隆': {'en': 'Clone', 'ru': 'Клонировать'},
    '恢复': {'en': 'Restore', 'ru': 'Восстановить'},
    '当前管理终端的MAC地址，可以手动更改为其他MAC地址': {
        'en': 'The MAC address of WAN, which can be manually changed to another MAC address',
        'ru': 'MAC-адрес WAN, который можно вручную изменить на другой MAC-адрес'
    },
    '工作模式切换': {'en': 'Working mode', 'ru': 'Режим работы'},
    '在路由器工作模式和中继工作模式之间进行切换': {
        'en': 'Switch between router working mode and relay working mode',
        'ru': 'Переключение между режимом работы как роутер и как ретранслятор'
    },
    '切换': {'en': 'Toggle', 'ru': 'Переключить'},
    'IPV6网络设置': {'en': 'IPV6 network settings', 'ru': 'Настройки сети IPV6'},
    '启用此功能后，Redmi路由器将开启IPv6上网功能（使用前请咨询网络运营商是否支持IPv6）': {
    ...
    '账号': {'en': 'Account', 'ru': 'Аккаунт'},
    '字节（网络正常情况下不建议修改）': {
        'en': 'Byte (modification is not recommended under normal network conditions)',
    ...
    '请手工选择需要的工作模式': {
        'en': 'Please select the desired working mode manually',
        'ru': 'Выберите желаемый режим работы вручную'
    },
    '获取中': {'en': 'Getting', 'ru': 'Получение'},
    '无线中继工作模式（扩展现有的无线网络）': {
        'en': 'Wireless relay working mode',
        'ru': 'Беспроводной ретранслятор'
    },
    '有线中继工作模式（扩展现有的网络）': {
        'en': 'Wired relay working mode',
        'ru': 'Проводной ретранслятор'
    },
    '普通路由器工作模式（创建一个无线网络）': {
        'en': 'Normal router working mode',
        'ru': 'Режим роутера'
    },
    '正在设置中，请稍候': {'en': 'Setting up, please wait', 'ru': 'Устанавливается. Пожалуйста, подождите'},
    '请不要关闭浏览器或断开路由器': {
        'en': 'Please do not close the browser or disconnect the router',
        'ru': 'Пожалуйста, не закрывайте браузер или отключайте роутер'
    },
    '请选择要扩大范围的无线网络': {
        'en': 'Please select a wireless network to extend the range',
        'ru': 'Пожалуйста, выберите беспроводную сеть, чтобы расширить ее радиус действия'
    },
    '选择网络': {
        'en': 'Choose network',
        'ru': 'Выберите сеть'
    ...
    '正在扫描附近的无线网络': {
        'en': 'Scanning for nearby wireless networks',
        'ru': 'Сканирование ближайших беспроводных сетей'
    },
    '网络名称': {'en': 'Network name', 'ru': 'Название сети'},
    '输入密码': {'en': 'Enter password', 'ru': 'Введите пароль'},
    ...
    '秒': {'en': ' secs ', 'ru': 'сек '},
    '天': {'en': ' days ', 'ru': ' дней '},
    '分钟': {'en': 'minutes', 'ru': 'минут'},
    '建议切换到': {'en': 'it is recommended to switch to ', 'ru': 'Рекомендуется переключиться на '},
    ...
    '修改局域网IP地址网段': {'en': 'Modify LAN IP address segment', 'ru': 'Изменить сегмент IP-адреса локальной сети'},
    '台湾地区': {'en': 'Taiwan', 'ru': 'Тайвань'},
    '韩国': {'en': 'South Korea', 'ru': 'Южная Корея'},
    '欧洲': {'en': 'Europe', 'ru': 'Европа'},
    '花生壳': {'en': 'Peanut shells'},
    '公云': {'en': 'Public cloud'},
    '检查更新失败': {'en': 'Checking for updates failed', 'ru': 'Проверка обновлений не удалась'},
    '路由器信息': {'en': 'Router information', 'ru': 'Информация роутера'},
    '外网状态': {'en': 'Internet status', 'ru': 'Состояние Интернета'},
    '外网带宽': {'en': 'Internet speed', 'ru': 'Скорость Интернета'},
    '下载带宽': {'en': 'Download speed', 'ru': 'Входящая скорость'},
    '访问外网': {'en': 'Access to the Internet', 'ru': 'Доступ в Интернет'},
    '全盘访问': {'en': 'Full access', 'ru': 'Полный доступ'},
    '本机': {'en': ' Native'},
    '已连接': {'en': 'Connected', 'ru': 'Подключено'},
    ...
    '发生未知错误，测速失败': {
        'en': 'Unknown error occurred, speed test failed',
        'ru': 'Произошла неизвестная ошибка, проверка скорости не удалась'
    },
    '重新测速': {'en': 'Retest', 'ru': 'Повторная проверка'},
    '完成': {'en': 'Finish', 'ru': 'Завершить'},
    '测速不准？': {'en': 'Inaccurate speed measurement? ', 'ru': 'Неточное измерение скорости? '},
    '上传带宽': {'en': 'Upload speed', 'ru': 'Исходящая скорость'},
    '手工设置': {'en': 'Manual settings', 'ru': 'Ручная настройка'},
    '最高上传速度': {'en': 'Maximum upload speed', 'ru': 'Максимальная исходящая скорость'},
    '最高下载速度': {'en': 'Maximum download speed', 'ru': 'Максимальная входящая скорость'},
    '限速设置': {'en': 'Speed limit settings', 'ru': 'Установка ограничений'},
    '确定': {'en': 'OK'},
    '上次测速': {'en': 'Last speed', 'ru': 'Последняя скорость'},
    '外网速度': {'en': 'Internet speed', 'ru': 'Скорость Интернета'},
    '开始测速': {'en': 'Start speed test', 'ru': 'Начать проверку скорости'},
    ...
    '网线连网设备': {'en': 'Network cable connection equipment', 'ru': 'Устройства с кабельным подключением'},
    '连网设备': {'en': ' connected devices', 'ru': ' подключенные устройства'},
    '访客连网设备': {'en': 'Guest networking device', 'ru': 'Гостевой сетевое устройство'},
    '你确认要关闭自己？': {'en': 'Are you sure you want to close it?', 'ru': 'Вы уверены, что хотите закрыть?'},
    '内测版': {'en': 'Current', 'ru': 'Текущий'},
    '小米路由器': {'en': 'Xiaomi Router ', 'ru': 'Роутер Xiaomi '},
    '开发版': {'en': 'stable version', 'ru': 'стабильная версия'},  # Google says it is 'Beta', but in code it refers as stable
    '青春版': {'en': 'Lite'},
    'WiFi密码: 未设置': {'en': 'Wi-Fi password: not set', 'ru': 'Пароль Wi-Fi: не установлен'},
    '正在拨号': {'en': 'Connecting', 'ru': 'Подключение'},
    '拨号成功': {'en': 'Connection success', 'ru': 'Подключение прошло успешно'},
    '断开': {'en': 'Disconnect', 'ru': 'Отключение'},
    '拨号失败': {'en': 'Connection failed', 'ru': 'Ошибка подключения'},
    '正在尝试特殊拨号模式': {'en': 'Trying special connection mode', 'ru': 'Пробуем специальный режим подключения'},
    '立即连接': {'en': 'Connect now', 'ru': 'Подключиться сейчас'},
    '任务管理器': {'en': 'Task manager'},
    '结束 {$pname} 后，相关功能将无法使用。如要再次使用，你需要在当前界面开启该任务。 你确认要结束 {$pname} 吗？': {'en': 'After closing {$pname}, the related function will not be available. To use it again, you need to start the task in the current interface. Are you sure you want to kill {$pname}?'},
    '提示': {'en': 'Hint'},
    '结束任务': {'en': 'kill task'},
    ...
    '仅支持WPA加密方式的设备将无法连接': {
        'en': 'Devices that only support WPA encryption will not be able to connect',
        'ru': 'Устройства, поддерживающие только WPA шифрование, не смогут подключиться'
    },
    '你手工选择的当前信道有可能造成部min机型较旧的设备无法连接': {
        'en': 'The current channel you manually select may cause some old devices fail to connect',
        'ru': 'Выбор вручную текущего канала может привести к тому, что некоторые старые устройства не смогут подключиться'
    },
    '网络异常，请检查是否联网': {
        'en': 'The network status is abnormal, please check whether the network is connected',
        'ru': 'Состояние сети ненормальное, проверьте, подключена ли сеть'
    },
    ...
    '设置成功正在重启，需要30秒请等待': {
        'en': 'The settings has been successful applied and service is restarting. It will take 30 seconds, please wait',
        'ru': 'Настройки были успешно применены, и служба перезапускается. Это займет 30 секунд, пожалуйста, подождите'
    },
    '修改WiFi设置': {'en': 'Modify Wi-Fi settings', 'ru': 'Изменить настройки Wi-Fi'},
    '该操作将重启 Wi-Fi 并导致 Wi-Fi 下的所有设备失去连接，是否确认修改？': {
        'en': 'This operation will restart Wi-Fi and cause all Wi-Fi devices to lose connection. Do you want to confirm the changes?',
    ...
    '你什么都没改变，提交什么啊': {
        ...
        'ru': 'Вы ничего не изменили, вы уверены?'
    },
    '切换国家或地区将会变更路由器的无线网络工作信道，需要重启后生效，是否确定？': {'en': 'Switching countries or regions will change the wireless network working channels. The router must be restarted to take effect. Are you sure?'},
    '切换国家或地区': {'en': 'Switch country or region '},
    '手工输入网络名称': {
        'en': 'Manually enter the network name',
        'ru': 'Введите имя сети вручную'
    },
    '恭喜，Redmi路由器一键中继设置成功！': {
        'en': 'Congratulations, the one-click relay setup of the Redmi router was successful!',
        'ru': 'Поздравляем, настройка ретранслятора роутера Redmi в один клик прошла успешно!'
    },
    '当前无线网络名称为': {
        'en': 'The current wireless network name is', 'ru': 'Текущее имя беспроводной сети:'
    },
    '当前Redmi路由器的IP地址为': {
        'en': 'The current IP address of the Redmi router is',
        'ru': 'Текущий IP-адрес роутера Redmi:'
    },
    '当前工作模式切换为普通路由器会恢复为之前路由器的所有设置': {
        'en': 'Switching the current working mode to a normal router will restore all the previous settings',
        'ru': 'Переключение текущего режима работы на обычный роутер восстановит все предыдущие настройки'
    },
    '是否确定切换路由器的工作模式？': {
        'en': 'Are you sure to switch the working mode of the router?',
        'ru': 'Вы уверены, что хотите переключить режим работы роутера?'
    },
    '恭喜，Redmi路由器切换为普通路由器工作模式成功！': {
        'en': 'Congratulations, the Redmi router was successfully switched to the normal router working mode!',
        'ru': 'Поздравляем, роутер Redmi успешно переведен в штатный режим работы роутера!'
    },
    ...
    '旧路由器与小米路由处于同一局域网中，可以互访': {'en': 'The old router and Xiaomi router are in the same local area network and can access each other'},
    ...
    '前缀需要以::结尾': {'en': ' prefix needs to end with ::', 'ru': ' префикс должен оканчиваться ::'},
    '适用于没有给路由分配IPv6前缀的上网环境，例如：上级光猫拨号': {'en': 'Applicable to the Internet environment where no IPv6 prefix is assigned to the route, for example: upper-level optical modem'},
    '设置页面': {'en': ' settings page', 'ru': ' страница настроек'},
    '账户': {'en': 'account', 'ru': 'аккаунт'},
    '问题排查': {'en': 'Troubleshoot', 'ru': 'Устранение неполадок'},
    '宽带拨号帐号密码输入错误': {
        'en': 'The PPPoE account password is incorrectly entered',
        'ru': 'Пароль учетной записи PPPoE введен неправильно'
    },
    '请检查帐号密码是否输入正确': {
        'en': 'Please check if the account password is entered correctly',
        'ru': 'Пожалуйста, проверьте правильность ввода пароля учетной записи'
    },
    '宽带因欠费无法继续使用': {
        'en': 'PPPoE service is not available due to arrears ',
    ...
    '特殊拨号': {'en': 'special connection', 'ru': 'специальное соединение'},
    '下一步': {'en': 'Next step', 'ru': 'Следующий шаг'},
    '获取失败': {'en': 'Get failed', 'ru': 'Неудачно'},
    '关闭IPv6设置成功': {'en': 'IPv6 settings were successfully turned off', 'ru': 'Настройки IPv6 были успешно отключены'},
    '关闭IPv6设置失败': {'en': 'Failed to turn off IPv6 settings', 'ru': 'Не удалось отключить настройки IPv6'},
    '联网方式设置中，请稍等': {'en': 'Network is being set up, please wait', 'ru': 'Сеть настраивается, пожалуйста, подождите'},
    ...
    '经过检测，建议使用DHCP方式(系统自动分配IP地址': {'en': 'After testing, it is recommended to use the DHCP method (the system automatically assigns an IP address'},
    '经过检测，建议使用静态IP方式': {'en': 'After testing, it is recommended to use static IP mode'},
    '经过检测，你的WAN口无法连通，可能网线没插好': {'en': 'After testing, your WAN port cannot be connected, maybe the network cable is not plugged in properly'},
    '经过检测，无法识别你的上网类型，请手工选择上网方式': {'en': 'After testing, your Internet access type cannot be recognized, please manually select the Internet access method'},
    ...
    '尝试无线中继失败了': {'en': 'Attempt wireless relay failed', 'ru': 'Ошибка включения беспроводного ретранслятора'},
    '尝试工作模式切换失败了': {'en': 'Attempt to switch work mode failed', 'ru': 'Попытка переключить режим работы не удалась'},
    '修改上网设置': {'en': 'Modify Internet settings', 'ru': 'Изменить настройки Интернета'},
    '无线访问控制': {'en': 'Wireless access control', 'ru': 'Контроль доступа к беспроводной сети'},
    '控制模式': {'en': 'control mode ', 'ru': 'режим управления'},
    '黑名单模式（不允许列表中设备访问）': {
        'en': 'Blacklist mode (list of forbidden)',
        'ru': 'Черный список (списку запрещен доступ)'
    },
    '白名单模式（只允许列表中设备访问）': {
        'en': 'Whitelist mode (list of allowed)',
        'ru': 'Белый список (списку разрешен доступ)'
    },
    '正在检测模式列表': {'en': 'Detecting current list', 'ru': 'Обнаружение текущего списка'},
    '正在查询中': {'en': 'Querying', 'ru': 'Запрос'},
    '设备名称': {'en': 'Device name', 'ru': 'Имя устройства'},
    '从在线列表添加': {'en': 'Add from online list', 'ru': 'Добавить в сети'},
    '手工添加': {'en': 'Manually added', 'ru': 'Добавлено вручную'},
    '保存并生效': {'en': 'Save and apply', 'ru': 'Сохранить и применить'},
    '修改管理密码': {'en': 'Change management password', 'ru': 'Изменить пароль роутера'},
    ...
    '设备信息': {'en': 'Device information', 'ru': 'Адреса устройства'},
    '连接时长': {'en': 'Connection time ', 'ru': 'Время подключения'},
    '添加': {'en': 'Add', 'ru': 'Добавить'},
    '删除': {'en': 'Delete', 'ru': 'Удалить'},
    '设备': {'en': 'Device', 'ru': 'Устройство'},
    '还没有设备添加进来': {'en': 'No devices have been added yet', 'ru': 'Устройства еще не были добавлены'},
    '您已经全部添加过了': {'en': 'You have added all', 'ru': 'Вы добавили всех'},
    '还没有设备连接进来': {'en': 'No device connected yet', 'ru': 'Устройства еще не были подключены'},
    '黑名单设备列表': {'en': 'List of blacklisted devices', 'ru': 'Список запрещенных устройств'},
    '白名单设备列表': {'en': 'List of whitelisted devices', 'ru': 'Список разрешенных устройств'},
    '没有白名单 所以没有model参数 默认设置成0 表示黑名单': {'en': 'There is no whitelist, so there is no model parameter. The default setting is 0, which means blacklist. '},
    '无线MAC地址过滤': {'en': 'Wireless MAC address filtering', 'ru': 'Фильтрация беспроводных MAC-адресов'},
    '您没有在列表中添加任何设备，保存后所有设备将无法访问网络！请返回修改': {'en': 'You have not added any devices to the list, all devices will not be able to access the network after saving! Please go back and edit'},
    '您没有将当前设备添加至白名单，保存后本机将无法访问网络！': {'en': 'You have not added the current device to the whitelist, the device will not be able to access the network after saving!'},
    '您将当前设备添加至黑名单，保存后本机将无法访问网络！': {'en': 'You have added the current device to the blacklist, and the device will not be able to access the network after saving it!'},
    '添加失败，Mesh路由不能添加到黑名单': {'en': 'Add failed, Mesh route cannot be added to the blacklist'},
    '请至少选择一个设备': {'en': 'Please select at least one device', 'ru': 'Пожалуйста, выберите хотя бы одно устройство'},
    '设备列表': {'en': ' Device List', 'ru': ' Список устройств'},
    '新密码与原密码相同': {'en': 'The new password is the same as the old one', 'ru': 'Новый пароль такой же, как и старый'},
    '服务': {'en': ' service', 'ru': ' сервис'},
    '开始': {'en': 'Start '},
    '租约': {'en': 'Lease ', 'ru': 'Срок выдачи '},
    '局域网': {'en': 'LAN'},
    '此操作需要重启才能生效，是否提交?': {
        'en': 'This operation requires a restart to take effect. Continue?',
        'ru': 'Эта операция требует перезагрузки для вступления в силу. Продолжить?'
    },
    '升级检测': {'en': 'Checking for updates', 'ru': 'Проверить обновления'},
    '手动升级': {'en': 'Manual update', 'ru': 'Ручное обновление'},
    ...
    'wifi设置(wifi名称和密码等)': {
        'en': 'Wi-Fi settings (Wi-Fi name and password, etc.)',
        'ru': 'Настройки Wi-Fi (имя и пароль Wi-Fi и т.д.)'
    },
    '上网设置(拨号方式和宽带帐号密码等)': {
        'en': 'Internet settings (WAN connection, PPPoE account password, etc.)',
        'ru': 'Настройки Интернета (WAN-соединение, пароль учетной записи PPPoE и т.д.)'
    },
    'DHCP服务和局域网IP设置': {
        'en': 'DHCP service and LAN IP settings',
        'ru': 'Сервис DHCP и настройки IP адресов локальной сети'
    },
    '路由器名和管理密码': {'en': 'Router name and admin password', 'ru': 'Имя роутера и пароль администратора'},
    '开始备份': {'en': 'Start backup', 'ru': 'Начать резервное копирование'},
    '原因，路由器设置备份失败！': {
        'en': 'For some reason the router settings backup failed!',
        'ru': 'По какой-то причине не удалось сделать резервную копию настроек роутера!'
    },
    '重试': {'en': 'Retry', 'ru': 'Повторить'},
    '请选择备份文件': {'en': 'Please select a backup file', 'ru': 'Выберите файл сохраненных настроек'},
    '开始恢复': {'en': 'Start recovery', 'ru': 'Начать восстановление'},
    '可选恢复的项目': {'en': 'Optional restored items', 'ru': 'Дополнительные восстановленные элементы'},
    '路由器设置恢复成功，重启路由器即可生效！': {
    ...
    '恢复出厂设置操作会抹掉当前路由器的所有设置': {
        'en': 'A factory reset will erase all current router settings',
        'ru': 'Сброс к заводским настройкам удалит все текущие настройки роутера'
    },
    '年': {'en': ' years ', 'ru': ' год '},
    '月': {'en': ' months ', 'ru': ' месяц '},
    '日': {'en': ' days ', 'ru': ' день '},
    '时': {'en': ' hours ', 'ru': ' час '},
    ...
    '正在检测更新，请稍候': {
        ...
        'ru': 'проверка обновления, подождите'
    },
    '当前路由器_': {'en': 'current router_', 'ru': 'текущий роутер_'},
    '你的版本是最新的，无需升级': {
        'en': 'Your version is up to date, update is not required',
    ...
    '你未选择文件，请重新选择': {
        ...
        'ru': 'Вы не выбрали файл, выберите еще раз'
    },
    '文件格式错误，请重新选择': {
        'en': 'File format error, please provide another file',
        'ru': 'Ошибка формата файла, укажите другой файл'
    },
    '从备份恢复路由器设置': {
        'en': 'Restoring router settings from backup',
        'ru': 'Восстановление настроек из резервной копии'
    },
    ...
    '根据应用优先级分配网速': {'en': 'Allocate internet speed based on application priority', 'ru': 'Распределить скорость интернета на основе приоритета приложений'},
    '自动模式': {'en': 'Automatic mode', 'ru': 'Автоматический режим'},
    '优先级模式': {'en': 'Priority mode', 'ru': 'Режим приоритета'},
    '手工限速模式': {'en': 'Manual speed limit mode', 'ru': 'Режим ручного ограничения скорости'},
    '游戏优先': {'en': 'Game priority', 'ru': 'Приоритет игр'},
    '网页优先': {'en': 'Web first', 'ru': 'Приоритет просмотра веб-страниц'},
    ...
    '端口转发开启了，不可以设置DMZ': {
        'en': 'Port forwarding is enabled, DMZ cannot be set',
        'ru': 'Включено перенаправление портов. DMZ не может быть активировано'
    },
    '设置DMZ': {'en': 'Setup DMZ', 'ru': 'Настройка DMZ'},
    '关闭成功，生效中，请稍候': {
        'en': 'Closed successfully, applying, please wait',
    ...
    '智能VPN分流': {'en': 'Smart VPN offload', 'ru': 'Умная разгрузка VPN'},
    '你可以自定义哪些服务或设备会走VPN的流量': {
        'en': 'You can customize which services or devices will use VPN',
        'ru': 'Вы можете настроить, какие службы или устройства будут использовать VPN'
    },
    '按服务地址分流': {'en': 'Redirection by service address', 'ru': 'Перенаправление по адресу сервиса'},
    '按设备分流': {'en': 'Redirection by device', 'ru': 'Перенаправление по устройству'},
    '可以通过添加服务地址来限定哪些服务流量会经过VPN': {'en': 'You can limit which service traffic will go through the VPN by adding service addresses'},
    '可以通过添加设备来限定哪些设备可以使用VPN流量': {'en': 'You can limit which devices can use VPN traffic by adding devices'},
    '从设备列表添加设备': {'en': 'Add a device from the device list', 'ru': 'Добавить устройство из списка устройств'},
    '通过MAC地址添加': {'en': 'Add by MAC address', 'ru': 'Добавить по MAC адресу'},
    '小米服务走VPN': {'en': 'Xiaomi service VPN'},
    '当你需要通过VPN使用外网时，可以开启此功能保证Redmi路由器APP远程服务可用，其他情况下关闭此功能': {'en': 'When you need to use the external network through VPN, you can turn on this function to ensure that the Redmi router APP remote service is available, otherwise turn off this function'},
    '断开连接': {'en': 'Disconnect', 'ru': 'Отключить'},
    '取消连接': {'en': 'Cancel the connection', 'ru': 'Прервать подключение'},
    '连接': {'en': 'Connect', 'ru': 'Включить'},
    '重连': {'en': 'Reconnect', 'ru': 'Переподключить'},
    '请输入设备的MAC地址': {'en': 'Please enter the MAC address of the device', 'ru': 'Пожалуйста, введите MAC-адрес устройства'},
    '连接失败': {'en': 'Connection failed', 'ru': 'Соединение не удалось'},
    '已断开': {'en': 'Disconnected', 'ru': 'Отключено'},
    '连接异常': {'en': 'Connection error', 'ru': 'Ошибка соединения'},
    '正在断开': {'en': 'Disconnecting', 'ru': 'Отключение'},
    '你确定要删除此项吗？': {
    ...
    '在线': {'en': 'Online'},
    '离线': {'en': 'Offline'},
    '开启该功能后，需要您重新连接VPN方可生效，且智能分流功能将关闭。若开启后发现路由器App远程访问出现异常，请您关闭。是否确认开启？': {'en': 'If enabled, you need to reconnect to the VPN for it to take effect, and the Smart Streaming feature will be disabled. If you find that there is an abnormality in the remote access of the router App after opening, please close it. Are you sure to turn it on?'},
    '请选择需要使用VPN的设备': {
        'en': 'Please select the device to be connected to VPN',
        'ru': 'Пожалуйста, выберите устройство для подключения к VPN'
    },
    '通过MAC地址添加要使用VPN的设备': {
        'en': 'Add devices to use VPN by MAC address',
        'ru': 'Добавьте устройства для использования VPN по MAC-адресу'},
    '添加要使用VPN的服务地址': {
    ...
    '需在': {'en': 'Required in '},
    '范围内取值': {'en': ' value in range'},
    '踢除阈值': {'en': 'Kick Threshold'},
    '取值范围': {'en': 'Ranges '},
    '没有UPnP设备': {'en': 'Not an UPnP device'},
    'UPnP未开启': {'en': 'UPnP is not enabled', 'ru': 'UPnP выключено'},
    '局域网IP地址': {'en': 'LAN IP address of the router'},
    '局域网IP': {'en': 'LAN IP'},
    '登录': {'en': 'Log in', 'ru': 'Войти'},
    '发生未知错误，请稍后再试~': {'en': 'Unknown error, please try again later'},
    '路由器管理密码不能为空': {
        'en': 'Router management password cannot be empty',
        'ru': 'Пароль управления роутером не может быть пустым'
    },
    ...
    '查看帮助': {'en': 'Help'},
    '建议您进行网络诊断定位具体问题': {'en': 'It is recommended to perform network diagnostics to locate specific problems'},
    '网络正常': {'en': 'The network is normal', 'ru': 'Состояние: нормальное'},
    '更多高级功能': {'en': 'Advanced features', 'ru': 'Расширенные настройки'},
    'Wi-Fi设置': {'en': 'Wi-Fi settings', 'ru': 'Настройки Wi-Fi'},
    '上网模式设置': {'en': 'Internet settings', 'ru': 'Настройки Интернет'},
    '宽带账号信息': {'en': 'ISP account information', 'ru': 'Аккаунт провайдера'},
    '下载小米WiFi App': {'en': 'Download Xiaomi WiFi App'},
    '畅想更多贴心智能功能': {'en': 'and get more functions'},
    ...
    '名称最多28字节': {'en': ' Name must be not more than 28 bytes'},
    '名称不能包含特殊字符': {'en': ' Name cannot contain special characters'},
    '密码不能为空': {'en': ' Password can not be blank'},
    '密码不少于8位': {'en': ' Password must be more than 8 characters'},
    ...
    '内容': {'en': 'Content'},
    '好的': {'en': 'OK'},
    '请选择上网连接类型': {'en': 'Please select the type of Internet connection'},
    '正在检测': {'en': 'Checking'},
    '宽带账号上网': {'en': 'Internet access with ISP account'},
    '自动获取IP': {'en': 'Obtain IP automatically'},
    '路由模式': {'en': 'Routing mode'},
    '无线中继': {'en': 'Wireless relay'},
    '有线中继': {'en': 'Wired relay'},
    '未能识别': {'en': 'Not recognized'},
    'Wi-Fi中继': {'en': 'Wi-Fi Relay'},
    '当前模式': {'en': 'Current mode'},
    '请输入账号/密码': {'en': 'Please enter login/password'},
    '走自动的逻辑': {'en': 'Automatic'},
    '不满足条件不走': {'en': 'Do not meet the conditions'},
    '走手动的逻辑': {'en': 'Manual'},
    'DNS配置': {'en': 'DNS configuration'},
    ...
    '请设置管理密码，至少8位': {'en': 'Please set an administrative password, at least 8 digits'},
    '路由器管理密码不少于8位': {'en': 'The router management password must be not less than 8 digits'},
    '路由器管理密码不多于63位': {'en': 'Router management password must be not more than 63 characters '},
    '将WiFi密码作为路由器管理密码': {'en': 'Use WiFi password as router admin password'},
    '路由空闲时为您自动升级固件版本，以便提供更好体验': {'en': 'Automatically upgrade the firmware version for better experience if the router is idle'},
    '请输入宽带运营商提供的账号密码': {'en': 'Please enter the account password provided by ISP'},
    '请输入账号或密码': {'en': 'Please enter login or password'},
    '宽带账号': {'en': 'ISP login'},
    ...
    '如果忘记宽带账号或密码，请联系您的': {'en': 'If you forget your ISP login or password, please contact your '},
    '宽带运营商': {'en': 'Internet Service Provider'},
    '联系宽带运营商': {'en': 'Contact your Internet Service Provider'},
    '宽带': {'en': 'Broadband'},
    '登录状态失效，请您重新登录': {'en': 'The login has expired, please log in again'},
    '至少需要一个url参数': {'en': 'At least one url parameter is required'},
    '中国电信': {'en': 'China Telecom'},
    '中国联通': {'en': 'China Unicom'},
    '中国移动': {'en': 'China Mobile'},
    '中国铁通': {'en': 'China Tietong'},
    '歌华有线': {'en': 'Gehua Cable'},
    '宽带通': {'en': 'Broadband'},
    '长城宽带': {'en': 'Great Wall Broadband'},
